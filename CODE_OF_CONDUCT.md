...
To report a Code of Conduct violation, please contact:

- **Email**: Use the contact email configured in your environment (`NEXT_PUBLIC_CONTACT_EMAIL` or `NEXT_PUBLIC_SUPPORT_EMAIL`)
- **GitHub Issues**: Create a private issue or contact repository maintainers directly
